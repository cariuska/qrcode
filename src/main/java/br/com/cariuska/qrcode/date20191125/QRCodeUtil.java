package br.com.cariuska.qrcode.date20191125;
...
public class QRCodeUtil {
    ...
    public static byte[] encode(String content, String logoImgPath, String destPath, boolean needCompress) throws Exception {
        /*
